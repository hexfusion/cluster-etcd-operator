...
// memberOpts holds values to drive the member-agent command.
...
// NewMemberAddCommand creates a member add command.
func NewMemberAddCommand(errOut io.Writer) *cobra.Command {
...
func (m *memberOpts) Run() error {
	...
	if err := cma.RequestClusterMemberConfig(); err != nil {
...
// NewClusterMemberAgent returns an initialized ClusterMemberAgent instance or an error is unsuccessful
func NewClusterMemberAgent(config ClusterMemberConfig, kubeconfigFile string) (*ClusterMemberAgent, error) {
